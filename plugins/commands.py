...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚠️Cʜᴀɴɴᴇʟ⚠️', url=f"https://telegram.me/ANiMeXGoDz"),
            InlineKeyboardButton('🎴Gʀᴏᴜᴘ🎴', url='https://t.me/Weebs_GoD')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚠️Aɴɪᴍᴇ⚠️', url=f"https://telegram.me/ANiMeXGoDz"),
            InlineKeyboardButton('🎴Gʀᴏᴜᴘ🎴', url='https://t.me/Weebs_GoD')
            ],[
             InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://telegram.me/ANiMeXGoDz')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
